...
<main class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-6">
        <div>
            ...
            <p class="text-body-secondary mb-0">Feature category details.</p>
        </div>
        <div class="d-flex gap-2">
            <a class="btn btn-outline-secondary" href="{{ route('admin.feature-categories.index') }}">Back</a>
            @if (Auth::user()->hasPermission('feature_categories.update'))
                <a class="btn btn-primary" href="{{ route('admin.feature-categories.edit', $category) }}">Edit</a>
            @endif
        </div>
    </div>
