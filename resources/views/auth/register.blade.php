            ...
            <div class="authentication-inner">
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <div>
                            @error('message')<p>{{ $errors }}</p>@enderror
                        </div>
                        <form id="formAuthentication" method="post" class="mb-6" action="{{ route('register') }}">
                            @csrf
                            <div class="mb-6">
                            ...
                            <button y class="btn btn-primary d-grid w-100">Sign up</button>
                        </form>
